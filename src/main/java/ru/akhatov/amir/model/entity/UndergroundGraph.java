...
import static ru.akhatov.amir.model.entity.NodeType.UNDERGROUND;

@Component
public class UndergroundGraph implements Graph {
    ...
    public void initialize() {
        logger.info("Initialize UnderGroundGraph START");
        nodes = nodeRepository.findAllByNodeType(UNDERGROUND);
        ...
        logger.info("Initialize UnderGroundGraph FINISH");
    }
